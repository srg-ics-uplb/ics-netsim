...
public class HostPortDialog extends CenterableDialog implements MouseListener {
    ...
    public HostPortDialog(MainFrame mainFrame) {
        ...
        try {
            BufferedImage image = ImageIO.read(loader.getResource("images/graphics/host.png"));
